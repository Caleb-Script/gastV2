...
-- mysql --database=gast --user=gast --password=p [< /sql/V1.0__Create.sql]
...
CREATE TABLE IF NOT EXISTS gast (
    ...
    kategorie     INT NOT NULL CHECK (kategorie >= 0 AND kategorie <= 9),
                  -- https://dev.mysql.com/doc/refman/8.1/en/bit-value-literals.html
    ...
    adresse_id    BINARY(16) UNIQUE REFERENCES adresse,
...
CREATE TABLE umsatz (
    ...
    kunde_id  BINARY(16) REFERENCES gast,
