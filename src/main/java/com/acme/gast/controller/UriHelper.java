...
class UriHelper {
    ...
    private static final String GAESTE_PREFIX = "/gaeste";
    ...
    private URI getBaseUriForwarded(final HttpServletRequest request, final String forwardedHost) {
        ...
        // x-forwarded-prefix: null bei Kubernetes Ingress Controller bzw. "/gaeste" bei Spring Cloud Gateway
        if (forwardedPrefix == null) {
            log.trace("getBaseUriForwarded: Kein '{}' im Header", X_FORWARDED_PREFIX);
            forwardedPrefix = GAESTE_PREFIX;
        }
