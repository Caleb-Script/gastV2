...
# Aufruf:   docker build --tag calebgyamfi/gast:2024.04.0-azul .
#               ggf. --progress=plain
#               ggf. --no-cache
...
COPY src ./src
COPY config/maven.properties /source/config/
...
java -Djarmode=layertools -jar ./target/gast-2024.04.0.jar extract
EOF
...
LABEL org.opencontainers.image.title="gast" \
      org.opencontainers.image.description="Microservice gast v0 mit Basis-Image Azul Zulu und Ubuntu Jammy" \
      org.opencontainers.image.version="2024.04.0-azul" \
      org.opencontainers.image.licenses="GPL-3.0-or-later" \
      org.opencontainers.image.vendor="Caleb Gyamfi" \
      org.opencontainers.image.authors="Caleb.Gyamfi@h-ka.de" \
