...
| Name | Email | Url |
| ---- | ------ | --- |
| Caleb Gyamfi | <Caleb_g@outlook.de> | <https://www.gentleHotel.com> |
...
| datasource.url | string | `"jdbc:postgresql://localhost/gast"` | URL für den DB-Zugriff |
| datasource.username | string | `"gast"` | Benutzername für das DB-System |
...
| image.name | string | `"gast"` | Name des Image |
| image.pullPolicy | string | `"Always"` | Pull-Policy für das Image |
| image.repository | string | `"calebgyamfi"` | Repository als Präfix beim Image-Namen |
