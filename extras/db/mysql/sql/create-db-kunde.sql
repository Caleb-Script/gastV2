...
--         mysql --user=root --password=p < /sql/create-db-gast.sql
--         exit
--     docker compose down
...
CREATE USER IF NOT EXISTS gast IDENTIFIED BY 'p';
GRANT USAGE ON *.* TO gast;

-- https://dev.mysql.com/doc/refman/8.2/en/create-database.html
-- https://dev.mysql.com/doc/refman/8.2/en/charset.html
-- SHOW CHARACTER SET;
CREATE DATABASE IF NOT EXISTS gast CHARACTER SET utf8;
