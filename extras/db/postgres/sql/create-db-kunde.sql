...
--        chown postgres:postgres /var/lib/postgresql/tablespace/gast
...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-gast.sql
--        psql --dbname=gast --username=gast --file=/sql/create-schema-gast.sql
...
CREATE ROLE gast LOGIN PASSWORD 'p';
...
CREATE TABLESPACE kundespace OWNER gast LOCATION '/var/lib/postgresql/tablespace/gast';
