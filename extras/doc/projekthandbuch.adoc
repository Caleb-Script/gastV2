...
.Use Cases für den Microservice "gast"
...
.Die Klasse "KundeDTO" für den Datenaustausch bei POST und PUT
[plantuml,KundeDTO,svg]
----
include::./KundeDTO.plantuml[]
----
...
.Die Entity-Klasse "Gast" für Gaestedaten
[plantuml,Gast,svg]
----
include::./Gast.plantuml[]
----
